...
function startGame(){
  ...
  (document.getElementById("button") as HTMLInputElement).src = startButtonImgGris;
  (document.getElementById("resButton") as HTMLInputElement).src = resButtonImg;
...
function restartGame(){
  ...
  (document.getElementById("button") as HTMLInputElement).src = startButtonImg;
  (document.getElementById("resButton") as HTMLInputElement).src = resButtonImgGris;
...
function setInitialPositions(){
  ...
  panguiCords=[[234,198],[252,198],[216,198], [270,198]]
